...
import { Sparkles, BellRing, Bell } from "lucide-react";
  ...
  const defaultCards = [
    {
      ...
      title: "Message",
      description: "Le site est ultra performant merci !",
      date: "Hier",
      iconClassName: "blue",
      titleClassName: "blue",
    },
    {
      ...
      icon: <Bell className="size-4 text-blue-300" />,
      title: "Message",
      description: "La maquette est top !",
      date: "Hier",
      iconClassName: "blue",
      titleClassName: "blue",
    },
    {
      ...
      icon: <BellRing className="size-4 text-blue-300" />,
      title: "Nouveau message",
      description: "J'ai besoin d'une landing page !",
      date: "Il y a 1 min",
      iconClassName: "blue",
      titleClassName: "blue",
    },
