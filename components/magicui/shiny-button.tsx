...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="before:content-['●']  before:text-green-500 before:mr-1 relative block size-full text-[12px]  tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
